...
public sealed class CachedReadOnlyOrderRepository : IReadOnlyOrderRepository
{
    ...
    public async ValueTask<EntityQueryResultPaginated<Order>> GetPaginatedAsync(int page, int pageSize, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<EntityQueryResultPaginated<Order>> GetByPaginatedAsync(Expression<Func<Order, bool>> predicate, int page, int pageSize, CancellationToken cancellationToken = default)
    {
